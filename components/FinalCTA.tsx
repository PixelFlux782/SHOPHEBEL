    ...
    <section className="py-32 px-6">
      <div className="max-w-4xl mx-auto text-center bg-white/[0.03] border border-white/10 rounded-3xl p-12 md:p-20 relative overflow-hidden shadow-[0_20px_100px_rgba(0,0,0,0.5),0_0_50px_rgba(37,99,235,0.05)] backdrop-blur-xl">
        ...
        <p className="text-brand-muted text-lg md:text-xl max-w-2xl mx-auto mb-12">
          Shophebel zeigt dir, wo Vertrauen, Klarheit und Conversion verloren gehen - und welche Massnahmen zuerst Wirkung bringen.
        </p>

        <Link href={ANALYSE_APP_URL} className="inline-flex bg-blue-600 text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-blue-600/90 transition-all transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-blue-600/20">
          Jetzt Website pruefen
        </Link>
      </div>
    </section>
  );
