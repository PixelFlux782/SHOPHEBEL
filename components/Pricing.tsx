...
const tiers = [
  { name: "Website-Check", price: "49 €", desc: "Automatisierter Quick-Report Ihrer Shop-Performance.", recommended: false },
  { name: "Shop-Optimierung", price: "490 €", desc: "Manuelle Experten-Analyse mit klaren Handlungsanweisungen.", recommended: true },
  { name: "Relaunch Begleitung", price: "Individuell", desc: "Komplette strategische Neuausrichtung Ihres Shops.", recommended: false },
];
